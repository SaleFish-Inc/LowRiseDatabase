...
CREATE OR ALTER FUNCTION NewStar.fnGetSalesTransaction
(
...
RETURN
	...
	(
		SELECT	m.NewStarProjectCode, NewStarLotNo, --mm.NewStarModelCode,
				...
				, mm.Elevation
				--, CONCAT(cmpAgent.name, cmpAgent.lastname) as SalesAgent
				...
				, mm.SalefishModelNo, mm.SalefishModelName--, t.MODEL_NAME, t.ELEVATION as elev--, SalefishLotNo, SalefishLotID
				--, t.template_id
				, mm.NewStarModelName
				, opt.option_description, opt.transaction_id, t.salesnote as SalesNote
...
select *
from NewStar.fnGetSalesTransaction('A0368', '1/1/2022', '6/30/2022', 1) --TH1801E0A
